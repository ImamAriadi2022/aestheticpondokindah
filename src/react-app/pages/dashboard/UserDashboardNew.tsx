...
import { getSession, clearSession } from "@/react-app/lib/demoAuth";
import { clearSessionStorage } from "@/react-app/lib/sessionTtl";
import { getMyConsultations } from "@/react-app/lib/consultationApi";
import { getMyComplaints } from "@/react-app/lib/complaintApi";
...
import DesktopReservasi from "@/react-app/components/dashboard/DesktopReservasi";
import DesktopKonsultasi from "@/react-app/components/dashboard/DesktopKonsultasi";
import DesktopPengaduan from "@/react-app/components/dashboard/DesktopPengaduan";
import AccountSidebar from "@/react-app/components/dashboard/AccountSidebar";
import DashboardRightPanel from "@/react-app/components/dashboard/DashboardRightPanel";

// Import mobile pages
import MobileHome from "@/react-app/pages/mobile/MobileHome";
import MobileBookingPage from "@/react-app/pages/mobile/MobileBooking";
import MobileBookingDoctorPage from "@/react-app/pages/mobile/MobileBookingDoctor";
import MobileBookingSchedulePage from "@/react-app/pages/mobile/MobileBookingSchedule";
import MobileBookingConfirmPage from "@/react-app/pages/mobile/MobileBookingConfirm";
import MobileBookingSuccessPage from "@/react-app/pages/mobile/MobileBookingSuccess";
import MobileKonsultasiPage from "@/react-app/pages/mobile/MobileKonsultasi";
import MobileRiwayatPage from "@/react-app/pages/mobile/MobileRiwayat";
import MobileAkunPage from "@/react-app/pages/mobile/MobileAkun";
