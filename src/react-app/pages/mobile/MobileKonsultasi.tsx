...
export default function MobileKonsultasiPage() {
        ...
        <div className="min-h-[calc(100vh-120px)] flex flex-col items-center justify-center p-6">
          ...
          <div className="w-full max-w-sm bg-gray-50 rounded-xl p-4 mb-6">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-[#c9a24a]/10 rounded-lg flex items-center justify-center">
                <Clock className="w-5 h-5 text-[#c9a24a]" />
              </div>
              <div>
                <p className="text-sm font-medium text-gray-900">Estimasi Respon</p>
                <p className="text-xs text-gray-500">15 - 30 menit</p>
              </div>
            </div>
          </div>
          ...
          <Button
            ...
            className="w-full max-w-sm h-14 bg-gradient-to-r from-[#c9a24a] to-[#a8843a] text-white font-semibold rounded-xl"
          >
  ...
  return (
    <NewMobileDashboardLayout role="user">
      ...
      <div className="px-4 py-3 bg-white border-b border-gray-100 flex items-center gap-3">
        {step !== "symptoms" && (
          <button
            onClick={() => setStep(step === "pain" ? "symptoms" : "pain")}
        ...
        <div>
          <h1 className="text-lg font-bold text-gray-900">Konsultasi Cepat</h1>
      ...
      <div className="p-4 space-y-4 pb-24">
        ...
        <div className="flex items-center gap-2 mb-6">
          <div className={`flex-1 h-1 rounded-full ${step === "symptoms" ? "bg-[#c9a24a]" : "bg-green-500"}`} />
          <div className={`flex-1 h-1 rounded-full ${step === "pain" ? "bg-[#c9a24a]" : step === "details" ? "bg-green-500" : "bg-gray-200"}`} />
          <div className={`flex-1 h-1 rounded-full ${step === "details" ? "bg-[#c9a24a]" : "bg-gray-200"}`} />
        </div>
        ...
        {step === "symptoms" && (
          <>
              ...
              {symptoms.map((symptom) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className={`text-sm font-medium ${isSelected ? "text-[#c9a24a]" : "text-gray-700"}`}>
                      {symptom.label}
                    </span>
                  </button>
                );
            ...
            <Button
              ...
              className="w-full h-14 mt-6 bg-gradient-to-r from-[#c9a24a] to-[#a8843a] text-white font-semibold rounded-xl disabled:opacity-50"
            >
              Selanjutnya
        ...
        {step === "pain" && (
          <>
            ...
            <Button
              ...
              className="w-full h-14 mt-6 bg-gradient-to-r from-[#c9a24a] to-[#a8843a] text-white font-semibold rounded-xl"
            >
              Selanjutnya
              <ChevronRight className="w-5 h-5 ml-2" />
            </Button>
        ...
        {step === "details" && (
          <>
            ...
            <div className="bg-gray-50 rounded-xl p-4 mb-4">
              <p className="text-xs text-gray-500 mb-2">Gejala Terpilih:</p>
              ...
              {painLevel && (
                <div className="mt-2 flex items-center gap-2">
                  <span className="text-xs text-gray-500">Tingkat nyeri:</span>
            ...
            <div className="mb-4">
              ...
              <textarea
                ...
                className="w-full h-32 p-4 bg-gray-50 rounded-xl text-sm text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-[#c9a24a]/30 resize-none"
              />
            </div>
            ...
            <div className="mb-4">
              ...
              <div className="flex gap-2">
                ...
                {attachments.length < 3 && (
                  <label className="w-20 h-20 rounded-xl border-2 border-dashed border-gray-300 flex flex-col items-center justify-center cursor-pointer hover:border-[#c9a24a] transition-colors">
