import{c as v,f as y,r as g,j as e,L as a,U as k}from"./index-6ONEipQs.js";import{C as u}from"./chevron-right-CMNsc6ku.js";import{C as w}from"./credit-card-BXzE58qt.js";import{C as E,M as F}from"./message-square-BPJ2UsFl.js";import{C as _}from"./circle-alert-CMEibJpH.js";import{C as D,S as B,L as P}from"./settings-DlFFMDTU.js";import{C as j}from"./calendar-days-C3t21v-N.js";import{S}from"./stethoscope-C7fLqTHz.js";import{P as U}from"./pen-line-yjgoUN2Z.js";import{A as L}from"./award-CjBPjDwG.js";import{S as M}from"./star-D3BW7Jb9.js";import{C as $}from"./shield-BABqw-_J.js";const R=[["rect",{width:"7",height:"9",x:"3",y:"3",rx:"1",key:"10lvy0"}],["rect",{width:"7",height:"5",x:"14",y:"3",rx:"1",key:"16une8"}],["rect",{width:"7",height:"9",x:"14",y:"12",rx:"1",key:"1hutg5"}],["rect",{width:"7",height:"5",x:"3",y:"16",rx:"1",key:"ldoo1y"}]],z=v("layout-dashboard",R);const T=[["polyline",{points:"22 7 13.5 15.5 8.5 10.5 2 17",key:"126l90"}],["polyline",{points:"16 7 22 7 22 13",key:"kwv8wd"}]],W=v("trending-up",T);function te({userName:n,onLogout:c}){const r=y(),[t,h]=g.useState(!1),[N,A]=g.useState(!1),i=()=>{h(s=>!s)},x=()=>{h(!1)},m=[{label:"Dashboard",href:"/dashboard/user",icon:z},{label:"Membership",href:"/membership",icon:w},{label:"Reservasi",href:"/dashboard/user?tab=reservasi",icon:E},{label:"Konsultasi",href:"/dashboard/user?tab=konsultasi",icon:F},{label:"Pengaduan",href:"/dashboard/user?tab=pengaduan",icon:_},{label:"Bantuan",href:"/help",icon:D}],l=s=>{const[o,p]=s.split("?");if(r.pathname!==o)return!1;const b=new URLSearchParams(p||"").get("tab"),C=r.search.startsWith("?")?r.search.slice(1):r.search,f=new URLSearchParams(C).get("tab")||"dashboard";return b?b===f:f==="dashboard"};return e.jsx("div",{className:"sticky top-4 left-0 h-[calc(100vh-32px)] self-start z-[100] pointer-events-auto ml-2 mr-2 flex-shrink-0",children:e.jsxs("aside",{className:`
