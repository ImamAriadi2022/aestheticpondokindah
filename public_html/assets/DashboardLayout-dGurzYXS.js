import{m as O,J as S,r as l,f as I,i as W,j as e,L as b,U as q,u as oe,t as le,p as ie,q as de}from"./index-ByQsJOXO.js";import{b as F,C as ce,S as J,L as Q,N as xe,A as be,D as ue}from"./NewMobileDashboardLayout-BWH6kq15.js";import{C as L,M as K,a as he}from"./message-square-CThMpt6u.js";import{U as T}from"./users-Bpvn1IcV.js";import{F as pe}from"./file-text-CPoQACAY.js";import{S as me}from"./stethoscope-CD2e8nlO.js";import{C as G}from"./chevron-right-fYzOvW9s.js";import{P as H}from"./pencil-BY7kSCGQ.js";import{D as Z}from"./download-42GO7wY9.js";import{C as fe}from"./chevron-down-D3li8WeW.js";const V=[{label:"Blog",href:"/dashboard/clinic?tab=content-blog"},{label:"Promo",href:"/dashboard/clinic?tab=content-promo"},{label:"Pop Up",href:"/dashboard/clinic?tab=content-popup"},{label:"Galeri",href:"/dashboard/clinic?tab=content-gallery"},{label:"Testimoni",href:"/dashboard/clinic?tab=content-testimonials"},{label:"Download App",href:"/dashboard/clinic?tab=content-download"}],ge={root:{[S.USER]:[{label:"Dashboard",icon:F,href:"/dashboard/user"},{label:"Konsultasi",icon:L,href:"/dashboard/user?tab=konsultasi"},{label:"Pengaduan",icon:O,href:"/dashboard/user?tab=pengaduan"}],[S.CLINIC]:[{label:"Dashboard",icon:F,href:"/dashboard/clinic"},{label:"Reservasi",icon:L,href:"/dashboard/clinic?tab=reservasi"},{label:"Konsultasi",icon:K,href:"/dashboard/clinic?tab=konsultasi"},{label:"Pengaduan",icon:O,href:"/dashboard/clinic?tab=pengaduan"},{label:"Konten",icon:pe,href:"/dashboard/clinic?tab=content-blog",submenu:V},{label:"Pengguna",icon:T,href:"/dashboard/clinic?tab=users"},{label:"Membership",icon:ce,href:"/dashboard/clinic/membership"},{label:"Dokter",icon:me,href:"/dashboard/clinic?tab=doctors"},{label:"Cabang Klinik",icon:he,href:"/dashboard/clinic?tab=branches"}],[S.DOCTOR]:[{label:"Dashboard",icon:F,href:"/dashboard/doctor"},{label:"Jadwal Praktik",icon:L,href:"/dashboard/doctor?tab=jadwal"},{label:"Reservasi Pasien",icon:T,href:"/dashboard/doctor?tab=reservasi"},{label:"Konsultasi Online",icon:K,href:"/dashboard/doctor?tab=konsultasi"}]}};function X(m){return ge.root[m]??[]}function ve({onLogout:m}){const[s,f]=l.useState(!1),[h,v]=l.useState(!1),o=l.useRef(null),C=l.useRef(null),A=I(),n=W();l.useEffect(()=>{const r=d=>{o.current&&!o.current.contains(d.target)&&C.current&&!C.current.contains(d.target)&&v(!1)};return document.addEventListener("mousedown",r),()=>document.removeEventListener("mousedown",r)},[]);const N=()=>{f(r=>!r),v(!1)},g=()=>{f(!1),v(!1)},_=r=>{const d=A.pathname,j=new URLSearchParams(A.search).get("tab"),[P,p]=r.split("?");if(d!==P)return!1;const u=p?new URLSearchParams(p).get("tab"):null;return u?j===u:!j},y=X("doctor");return e.jsx("div",{className:"sticky top-4 left-0 h-[calc(100vh-32px)] self-start z-[100] pointer-events-auto ml-2 mr-2 flex-shrink-0",children:e.jsxs("aside",{className:`
        ...
        `,children:[e.jsx("div",{className:"absolute inset-0 rounded-[28px] bg-gradient-to-br from-[#C9A24A]/10 via-transparent to-[#B8943F]/10 pointer-events-none"}),e.jsx("div",{className:"absolute inset-[1px] rounded-[27px] border border-[#C9A24A]/10 pointer-events-none"}),e.jsx("div",{className:"relative z-10 flex items-center justify-center h-16 px-4",children:e.jsx("button",{onClick:N,className:`
            ...
            `,children:[e.jsx("div",{className:"absolute inset-0 rounded-[28px] bg-gradient-to-br from-[#C9A24A]/10 via-transparent to-[#B8943F]/10 pointer-events-none"}),e.jsx("div",{className:"absolute inset-[1px] rounded-[27px] border border-[#C9A24A]/10 pointer-events-none"}),e.jsx("div",{className:"relative z-10 flex items-center justify-center h-16 px-4",children:e.jsx("button",{onClick:P,className:`
                ...
                `,"aria-label":o?"Tutup sidebar":"Buka sidebar",children:e.jsx(G,{className:"w-5 h-5",strokeWidth:2.5})})}),e.jsx("div",{className:"mx-5 h-px bg-gradient-to-r from-transparent via-[#C9A24A]/40 to-transparent"}),e.jsx("nav",{className:"relative z-10 flex-1 flex flex-col gap-2 px-3 py-4",children:se.map(t=>{const c=R(t.href);if(s==="clinic"&&t.label==="Konten"){const x=re();return e.jsxs("button",{ref:N,type:"button",onClick:()=>{const i=!A;if(i&&N.current){const w=N.current.getBoundingClientRect();_({top:w.top,left:w.right+12})}i&&!x&&B(t.href),n(i)},className:`
                        group relative flex items-center
                      ...
                      `,children:e.jsx(t.icon,{className:"w-[18px] h-[18px]",strokeWidth:x?2.5:2})}),o&&e.jsxs(e.Fragment,{children:[e.jsx("span",{className:`
                          ...
                          `,children:t.label}),e.jsx(fe,{className:`
