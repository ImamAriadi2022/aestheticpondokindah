import{c as y,f as S,i as F,r as c,m as M,j as e,L as x,U as $,A as L}from"./index-C3qZIZYp.js";import{a as R,S as z,L as O}from"./settings-BhCKR_Dj.js";import{C as P}from"./chevron-right-L_s2ugCb.js";import{C as I}from"./credit-card-BIZ8yQKb.js";import{C as T}from"./map-pin-Do2hDYn0.js";import{M as U}from"./message-square-JzKVFaj8.js";import{C as K}from"./chevron-down-Km6HZcDV.js";import{D as W}from"./download-B23K_Riz.js";import{P as q}from"./pen-line-CwNn6nJq.js";import{A as H}from"./award-C6foRQWw.js";import{S as J}from"./star-VB0cm8lx.js";import{S as G}from"./sparkles-DO38QyCR.js";const Q=[["rect",{width:"7",height:"9",x:"3",y:"3",rx:"1",key:"10lvy0"}],["rect",{width:"7",height:"5",x:"14",y:"3",rx:"1",key:"16une8"}],["rect",{width:"7",height:"9",x:"14",y:"12",rx:"1",key:"1hutg5"}],["rect",{width:"7",height:"5",x:"3",y:"16",rx:"1",key:"ldoo1y"}]],V=y("layout-dashboard",Q);const Z=[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"m4.93 4.93 4.24 4.24",key:"1ymg45"}],["path",{d:"m14.83 9.17 4.24-4.24",key:"1cb5xl"}],["path",{d:"m14.83 14.83 4.24 4.24",key:"q42g0n"}],["path",{d:"m9.17 14.83-4.24 4.24",key:"bqpfvv"}],["circle",{cx:"12",cy:"12",r:"4",key:"4exip2"}]],X=y("life-buoy",Z);const Y=[["path",{d:"M21.174 6.812a1 1 0 0 0-3.986-3.987L3.842 16.174a2 2 0 0 0-.5.83l-1.321 4.352a.5.5 0 0 0 .623.622l4.353-1.32a2 2 0 0 0 .83-.497z",key:"1a8usu"}],["path",{d:"m15 5 4 4",key:"1mk7zo"}]],ee=y("pencil",Y);function pe({userName:s,onLogout:A}){const u=S(),t=F(),[r,w]=c.useState(()=>{try{const a=localStorage.getItem("apident:sidebar_expanded");return a!==null?JSON.parse(a):!1}catch{return!1}}),[m,o]=c.useState(!1),[g,C]=c.useState(!1),N=c.useRef(null),b=c.useRef(null),k=()=>{w(a=>{const i=!a;try{localStorage.setItem("apident:sidebar_expanded",JSON.stringify(i))}catch{}return i}),o(!1)},l=()=>{o(!1)};c.useEffect(()=>{const a=i=>{N.current&&!N.current.contains(i.target)&&b.current&&!b.current.contains(i.target)&&o(!1)};return document.addEventListener("mousedown",a),()=>document.removeEventListener("mousedown",a)},[]);const n=[{label:"Dashboard",href:"/dashboard/user",icon:V},{label:"Membership",href:"/membership",icon:I},{label:"Reservasi",href:"/dashboard/user?tab=reservasi",icon:T},{label:"Konsultasi",href:"/dashboard/user?tab=konsultasi",icon:U}],d=[{label:"Pusat Bantuan (FAQ)",href:"/help",icon:R},{label:"Pengaduan & Masukan",href:"/dashboard/user?tab=pengaduan",icon:M}],h=a=>{const[i,j]=a.split("?");if(u.pathname!==i)return!1;const E=new URLSearchParams(j||"").get("tab"),B=u.search.startsWith("?")?u.search.slice(1):u.search,_=new URLSearchParams(B).get("tab")||"dashboard";return E?E===_:_==="dashboard"},v=d.some(a=>h(a.href)),p=s||t?.name||"Pengguna",D=t?.email||"user@aestheticpondokindah.local";return e.jsx("div",{className:"sticky top-4 left-0 h-[calc(100vh-32px)] self-start z-[100] pointer-events-auto ml-2 mr-2 flex-shrink-0",children:e.jsxs("aside",{className:`
        ...
        `,children:[e.jsx("div",{className:"absolute inset-0 rounded-[28px] bg-gradient-to-br from-[#C9A24A]/10 via-transparent to-[#B8943F]/10 pointer-events-none"}),e.jsx("div",{className:"absolute inset-[1px] rounded-[27px] border border-[#C9A24A]/10 pointer-events-none"}),e.jsx("div",{className:"relative z-10 flex items-center justify-center h-16 px-4",children:e.jsx("button",{onClick:k,className:`
            ...
            `,"aria-label":r?"Tutup sidebar":"Buka sidebar",children:e.jsx(P,{className:"w-5 h-5",strokeWidth:2.5})})}),e.jsx("div",{className:"mx-5 h-px bg-gradient-to-r from-transparent via-[#C9A24A]/40 to-transparent"}),e.jsxs("nav",{className:"relative z-10 flex-1 flex flex-col gap-2 px-3 py-4 overflow-y-auto overflow-x-hidden",children:[n.map(({label:a,href:i,icon:j})=>{const f=h(i);return e.jsxs(x,{to:i,onClick:l,className:`
              ...
              `,children:[e.jsxs("div",{className:"flex items-center gap-3 min-w-0",children:[e.jsx("div",{className:`
                ...
                `,children:e.jsx(X,{className:"w-[18px] h-[18px]",strokeWidth:v?2.5:2})}),e.jsx("span",{className:`
                ...
                `,children:"Bantuan & Pengaduan"})]}),r&&e.jsx(K,{className:`w-4 h-4 text-[#A89F91] transition-transform duration-300 shrink-0 ${g?"rotate-180 text-[#E8C547]":""}`}),!r&&e.jsxs("div",{className:`
                  ...
                  shadow-[0_4px_20px_rgba(0,0,0,0.3)]
                  z-50
                `,children:["Bantuan & Pengaduan",e.jsx("div",{className:"absolute left-0 top-1/2 -translate-x-1 -translate-y-1/2 w-2 h-2 bg-[#1a1612] border-l border-t border-[#C9A24A]/40 rotate-45"})]})]}),r&&(g||v)&&e.jsx("div",{className:"ml-4 mt-1 pl-3 border-l-2 border-[#C9A24A]/30 space-y-1 py-1",children:d.map(a=>{const i=h(a.href),j=a.icon;return e.jsxs(x,{to:a.href,onClick:l,className:`
                        flex items-center gap-2.5 px-3 py-2 rounded-xl text-xs font-semibold transition-all
                        ${i?"bg-[#C9A24A]/30 text-[#E8C547] border border-[#C9A24A]/40":"text-[#A89F91] hover:text-[#E8C547] hover:bg-[#2a2319]"}
              ...
              `,children:[e.jsx("p",{className:"text-sm font-semibold text-[#E8C547] whitespace-nowrap",children:p}),e.jsx("p",{className:"text-xs text-[#A89F91] whitespace-nowrap",children:"Pasien"})]}),!r&&!m&&e.jsxs("div",{className:`
                  ...
                  shadow-[0_4px_20px_rgba(0,0,0,0.3)]
                  z-50
                `,children:[e.jsx("p",{className:"font-semibold",children:p}),e.jsx("p",{className:"text-xs text-[#A89F91]",children:"Pasien"}),e.jsx("div",{className:"absolute left-0 top-1/2 -translate-x-1 -translate-y-1/2 w-2 h-2 bg-[#1a1612] border-l border-t border-[#C9A24A]/40 rotate-45"})]})]}),m&&e.jsxs("div",{ref:N,className:`
