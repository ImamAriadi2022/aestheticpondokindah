import{c as v,f as y,r as g,j as e,n as k,L as a,U as E}from"./index-BfCF8LNW.js";import{C as u}from"./chevron-right-C2A_p_hG.js";import{C as w}from"./credit-card-B4QsE7Yw.js";import{C as F}from"./map-pin-htiWLdYA.js";import{M as _}from"./message-square-C__LZ5aI.js";import{a as D,S as B,L as P}from"./settings-D7xckZqX.js";import{C as j}from"./calendar-days-DwguMObI.js";import{S}from"./stethoscope-CRi7uSoz.js";import{P as U}from"./pen-line-z9VNr8BG.js";import{A as L}from"./award-DJbjaI20.js";import{S as M}from"./star-C_bf2cqe.js";import{C as $}from"./shield-BR0zE-d9.js";const R=[["rect",{width:"7",height:"9",x:"3",y:"3",rx:"1",key:"10lvy0"}],["rect",{width:"7",height:"5",x:"14",y:"3",rx:"1",key:"16une8"}],["rect",{width:"7",height:"9",x:"14",y:"12",rx:"1",key:"1hutg5"}],["rect",{width:"7",height:"5",x:"3",y:"16",rx:"1",key:"ldoo1y"}]],z=v("layout-dashboard",R);const T=[["polyline",{points:"22 7 13.5 15.5 8.5 10.5 2 17",key:"126l90"}],["polyline",{points:"16 7 22 7 22 13",key:"kwv8wd"}]],W=v("trending-up",T);function te({userName:n,onLogout:c}){const r=y(),[t,h]=g.useState(!1),[N,A]=g.useState(!1),i=()=>{h(s=>!s)},x=()=>{h(!1)},m=[{label:"Dashboard",href:"/dashboard/user",icon:z},{label:"Membership",href:"/membership",icon:w},{label:"Reservasi",href:"/dashboard/user?tab=reservasi",icon:F},{label:"Konsultasi",href:"/dashboard/user?tab=konsultasi",icon:_},{label:"Pengaduan",href:"/dashboard/user?tab=pengaduan",icon:k},{label:"Bantuan",href:"/help",icon:D}],l=s=>{const[o,p]=s.split("?");if(r.pathname!==o)return!1;const b=new URLSearchParams(p||"").get("tab"),C=r.search.startsWith("?")?r.search.slice(1):r.search,f=new URLSearchParams(C).get("tab")||"dashboard";return b?b===f:f==="dashboard"};return e.jsx("div",{className:"sticky top-4 left-0 h-[calc(100vh-32px)] self-start z-[100] pointer-events-auto ml-2 mr-2 flex-shrink-0",children:e.jsxs("aside",{className:`
        ...
        `,children:[e.jsx("div",{className:"absolute inset-0 rounded-[28px] bg-gradient-to-br from-[#C9A24A]/10 via-transparent to-[#B8943F]/10 pointer-events-none"}),e.jsx("div",{className:"absolute inset-[1px] rounded-[27px] border border-[#C9A24A]/10 pointer-events-none"}),e.jsx("div",{className:"relative z-10 flex items-center justify-center h-16 px-4",children:e.jsx("button",{onClick:i,className:`
            ...
            `,"aria-label":t?"Tutup sidebar":"Buka sidebar",children:e.jsx(u,{className:"w-5 h-5",strokeWidth:2.5})})}),e.jsx("div",{className:"mx-5 h-px bg-gradient-to-r from-transparent via-[#C9A24A]/40 to-transparent"}),e.jsx("nav",{className:"relative z-10 flex-1 flex flex-col gap-2 px-3 py-4",children:m.map(({label:s,href:o,icon:p})=>{const d=l(o);return e.jsxs(a,{to:o,onClick:x,className:`
