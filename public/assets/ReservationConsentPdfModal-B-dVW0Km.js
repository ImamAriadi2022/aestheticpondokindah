import{c as N,A as R,r as o,j as e,B as x,X as w,C,U as L,S as M}from"./index-CJmWCpme.js";import{D as A,a as D,b as E,e as P}from"./dialog-u35-Z3Kr.js";import{F as B}from"./file-text-C8thI3jh.js";import{B as T}from"./building-2-MXDiwJfN.js";import{S as F}from"./shield-check-5DvFFg8N.js";import{S as z}from"./sparkles-BxgPizYn.js";import{C as $}from"./message-square-749U1Ubt.js";import{C as U}from"./shield-Us-LUJku.js";const J=[["path",{d:"M7.9 20A9 9 0 1 0 4 16.1L2 22Z",key:"vv11sd"}]],Z=N("message-circle",J);const W=[["path",{d:"M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2",key:"143wyd"}],["path",{d:"M6 9V3a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1v6",key:"1itne7"}],["rect",{x:"6",y:"14",width:"12",height:"8",rx:"1",key:"1ue0tg"}]],j=N("printer",W);async function K(){const i=await fetch(`${R}/public/settings`,{headers:{Accept:"application/json"}});return i.ok?i.json():{}}function q({isOpen:i,onClose:s,onAccept:l,showAcceptButton:r=!1}){const[k,c]=o.useState(null),[g,h]=o.useState(null),[u,m]=o.useState(!1);o.useEffect(()=>{i&&(m(!0),K().then(a=>{a.pdf_terms_and_conditions&&h(a.pdf_terms_and_conditions),a.booking_terms&&a.booking_terms.trim().length>0&&c(a.booking_terms)}).catch(()=>{}).finally(()=>m(!1)))},[i]);const d=()=>{const a=document.createElement("iframe");a.style.position="fixed",a.style.right="0",a.style.bottom="0",a.style.width="0",a.style.height="0",a.style.border="0",document.body.appendChild(a);const n=a.contentWindow?.document;if(!n){window.print();return}const f=`
      <!DOCTYPE html>
      <html>
        <head>
          <meta charset="utf-8" />
    ...
    `;n.open(),n.write(f),n.close(),setTimeout(()=>{a.contentWindow?.focus(),a.contentWindow?.print(),setTimeout(()=>{document.body.removeChild(a)},1e3)},350)};return e.jsx(A,{open:i,onOpenChange:a=>!a&&s(),children:e.jsxs(D,{className:"w-[95vw] max-w-4xl lg:max-w-4xl xl:max-w-5xl max-h-[92vh] flex flex-col p-0 rounded-3xl bg-[#FAF8F5] border border-[#E8DFC8] shadow-2xl text-left",children:[e.jsxs("div",{className:"flex items-center justify-between px-6 py-4 bg-white/95 backdrop-blur-md border-b border-[#E8DFC8] rounded-t-3xl shrink-0",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("div",{className:"w-10 h-10 rounded-2xl bg-[#FAF5EA] text-[#8C6B1C] flex items-center justify-center border border-[#EADBBD] shadow-inner",children:e.jsx(B,{className:"w-5 h-5 text-[#8C6B1C]"})}),e.jsxs("div",{children:[e.jsx(E,{className:"text-base sm:text-lg font-bold text-[#2C2416]",children:"Dokumen Syarat & Ketentuan Layanan Pasien"}),e.jsx(P,{className:"text-xs text-[#8C8272]",children:"Kebijakan operasional, aturan penjadwalan, tata tertib, dan perlindungan privasi klinik."})]})]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsxs(x,{type:"button",onClick:d,className:"h-9 px-4 rounded-xl bg-[#8C6B1C] hover:bg-[#735614] text-white text-xs font-bold shadow-xs flex items-center gap-1.5 cursor-pointer",children:[e.jsx(j,{className:"w-3.5 h-3.5"}),e.jsx("span",{children:"Cetak / Simpan PDF"})]}),e.jsx("button",{onClick:s,className:"w-8 h-8 rounded-full bg-[#F5ECE0] hover:bg-[#EADBBD] text-[#4A3F35] flex items-center justify-center transition-colors cursor-pointer",children:e.jsx(w,{className:"w-4 h-4"})})]})]}),e.jsx("div",{className:"flex-1 overflow-y-auto p-4 sm:p-6 bg-[#EDE5D6]/30",children:e.jsxs("div",{className:"max-w-3xl mx-auto bg-white p-6 sm:p-10 rounded-2xl shadow-md border border-[#E0D7C4] text-[#2C2416] space-y-6",children:[e.jsxs("div",{className:"border-b-2 border-[#8C6B1C] pb-4 text-center space-y-1",children:[e.jsxs("div",{className:"flex items-center justify-center gap-2 text-[#8C6B1C]",children:[e.jsx(T,{className:"w-5 h-5"}),e.jsx("h1",{className:"text-lg sm:text-xl font-black uppercase tracking-wider",children:"Aesthetic Pondok Indah"})]}),e.jsx("p",{className:"text-xs sm:text-sm font-bold text-[#4A3F35]",children:"DENTAL CLINIC & IMPLANT CENTER"}),e.jsxs("p",{className:"text-[11px] text-[#7A6E60] leading-relaxed",children:["Jl. Metro Pondok Indah Blok TB No. 12, Kebayoran Lama, Jakarta Selatan 12310",e.jsx("br",{}),"Telepon: (021) 765-4321 | WhatsApp Layanan: 0812-3456-7890 | Website: https://aestheticpondokindah.web.id"]})]}),e.jsxs("div",{className:"text-center space-y-1 py-1 bg-[#FAF8F5] rounded-xl border border-[#EDE5D6] p-3",children:[e.jsx("h2",{className:"text-sm sm:text-base font-extrabold uppercase text-[#2C2416] tracking-wide",children:"Syarat dan Ketentuan Layanan Pasien"}),e.jsx("p",{className:"text-[11px] text-[#8C6B1C] font-semibold",children:"DOKUMEN KEBIJAKAN OPERASIONAL & PERJANJIAN LAYANAN KLINIK"})]}),e.jsxs("div",{className:"space-y-4 text-xs sm:text-sm leading-relaxed text-[#3D332A]",children:[e.jsxs("div",{className:"space-y-1.5",children:[e.jsx("h3",{className:"font-bold text-[#8C6B1C] text-xs uppercase tracking-wide border-b border-[#EADBBD] pb-1",children:"1. Ketentuan Umum & Pendaftaran Layanan"}),e.jsxs("ol",{className:"list-decimal pl-5 space-y-1 text-[#4A3F35] text-xs",children:[e.jsx("li",{children:"Seluruh reservasi konsultasi dan tindakan medis gigi di Aesthetic Pondok Indah Dental Clinic wajib didaftarkan melalui platform reservasi resmi klinik atau bagian resepsionis."}),e.jsx("li",{children:"Pasien atau wali sah wajib memberikan data identitas diri, nomor kontak aktif, serta riwayat medis yang akurat dan dapat dipertanggungjawabkan."}),e.jsx("li",{children:"Klinik berhak memverifikasi identitas pasien saat kedatangan untuk keperluan administrasi dan rekam medis elektronik."})]})]}),e.jsxs("div",{className:"space-y-1.5",children:[e.jsx("h3",{className:"font-bold text-[#8C6B1C] text-xs uppercase tracking-wide border-b border-[#EADBBD] pb-1",children:"2. Ketentuan Penjadwalan, Kedatangan & Reschedule"}),e.jsxs("ol",{className:"list-decimal pl-5 space-y-1 text-[#4A3F35] text-xs",children:[e.jsx("li",{children:"Pasien diharapkan hadir di klinik minimal 15 (lima belas) menit sebelum estimasi jam tindakan untuk proses registrasi dan pengecekan awal."}),e.jsx("li",{children:"Keterlambatan lebih dari 20 menit dari waktu jadwal yang telah dikonfirmasi dapat mengakibatkan penyesuaian durasi perawatan atau penjadwalan ulang (*reschedule*) demi kenyamanan antrean pasien berikutnya."}),e.jsx("li",{children:"Permohonan perubahan jadwal (*reschedule*) dapat dilakukan maksimal 4 (empat) jam sebelum jadwal tindakan melalui sistem atau staf klinik."})]})]}),e.jsxs("div",{className:"space-y-1.5",children:[e.jsx("h3",{className:"font-bold text-[#8C6B1C] text-xs uppercase tracking-wide border-b border-[#EADBBD] pb-1",children:"3. Tata Tertib & Prosedur Medis Klinik"}),e.jsxs("ol",{className:"list-decimal pl-5 space-y-1 text-[#4A3F35] text-xs",children:[e.jsx("li",{children:"Sebelum tindakan medis dilakukan, dokter gigi yang bertugas akan melakukan pemeriksaan klinis dan menjelaskan rencana perawatan, indikasi, serta estimasi biaya."}),e.jsxs("li",{children:["Tindakan medis invasif, bedah minor, restorasi lanjutan, dan estetik memerlukan penandatanganan ",e.jsx("strong",{children:"Surat Pernyataan dan Persetujuan Pasien (Informed Consent)"})," yang sah."]}),e.jsx("li",{children:"Pasien wajib mematuhi seluruh instruksi pra-tindakan dan pasca-tindakan yang diberikan oleh dokter gigi demi efektivitas dan keamanan hasil perawatan."})]})]}),e.jsxs("div",{className:"space-y-1.5",children:[e.jsx("h3",{className:"font-bold text-[#8C6B1C] text-xs uppercase tracking-wide border-b border-[#EADBBD] pb-1",children:"4. Kebijakan Pembayaran & Jaminan Layanan"}),e.jsxs("ol",{className:"list-decimal pl-5 space-y-1 text-[#4A3F35] text-xs",children:[e.jsx("li",{children:"Pembayaran tagihan tindakan dapat dilakukan secara tunai, kartu debit/kredit, transfer bank, maupun metode pembayaran digital resmi yang disediakan klinik."}),e.jsx("li",{children:"Setiap perawatan bergaransi (seperti pemasangan veneer porselen atau implan tertentu) tunduk pada syarat kontrol berkala sesuai rekomendasi dokter penanggung jawab."})]})]}),e.jsxs("div",{className:"space-y-1.5",children:[e.jsx("h3",{className:"font-bold text-[#8C6B1C] text-xs uppercase tracking-wide border-b border-[#EADBBD] pb-1",children:"5. Kerahasiaan Data Pribadi & Rekam Medis"}),e.jsxs("ol",{className:"list-decimal pl-5 space-y-1 text-[#4A3F35] text-xs",children:[e.jsx("li",{children:"Aesthetic Pondok Indah menjamin kerahasiaan data pribadi dan rekam medis pasien sesuai dengan peraturan perundang-undangan kesehatan yang berlaku di Republik Indonesia."}),e.jsx("li",{children:"Dokumentasi klinis (foto gigi intraoral/ekstraoral dan rontgen panoramic) digunakan secara ketat untuk kepentingan diagnosis medis dan rekam jejak kesehatan gigi pasien."})]})]})]}),e.jsxs("div",{className:"pt-4 border-t border-[#E8DFC8] text-center text-[11px] text-[#7A6E60] space-y-1",children:[e.jsx("p",{className:"font-semibold text-[#8C6B1C]",children:"Aesthetic Pondok Indah Dental Clinic — Standar Pelayanan & Keselamatan Pasien Terakreditasi"}),e.jsx("p",{children:"Dokumen ini merupakan standar resmi syarat & ketentuan layanan klinik yang berlaku mengikat bagi seluruh pasien terdaftar."})]})]})}),e.jsxs("div",{className:"px-6 py-4 bg-white border-t border-[#E8DFC8] rounded-b-3xl flex items-center justify-between gap-3 shrink-0",children:[e.jsxs("div",{className:"flex items-center gap-2 text-xs text-[#8C8272]",children:[e.jsx(F,{className:"w-4 h-4 text-emerald-600 shrink-0"}),e.jsx("span",{children:"Dokumen Syarat & Ketentuan Resmi Terverifikasi"})]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(x,{type:"button",variant:"outline",onClick:s,className:"h-9 px-4 rounded-xl border-[#D9D0BC] text-[#4A3F35] hover:bg-[#FAF8F5] text-xs font-semibold cursor-pointer",children:"Tutup"}),r&&l&&e.jsxs(x,{type:"button",onClick:()=>{l(),s()},className:"h-9 px-5 rounded-xl bg-[#8C6B1C] hover:bg-[#735614] text-white text-xs font-bold shadow-xs flex items-center gap-1.5 cursor-pointer",children:[e.jsx(C,{className:"w-3.5 h-3.5"}),e.jsx("span",{children:"Saya Menyetujui Syarat & Ketentuan"})]})]})]})]})})}function ee({isOpen:i,onClose:s,bookingCode:l,patientName:r,patientPhone:k,isGuest:c,serviceName:g,doctorName:h,dateStr:u,timeStr:m,signatureData:d,acceptedAt:a}){const[n,f]=o.useState(null),[p,S]=o.useState(null);if(o.useEffect(()=>{i&&K().then(t=>{t.pdf_informed_consent&&S(t.pdf_informed_consent),t.booking_terms&&t.booking_terms.trim().length>0&&f(t.booking_terms)}).catch(()=>{})},[i]),!i)return null;const v=a?new Date(a).toLocaleDateString("id-ID",{day:"numeric",month:"long",year:"numeric",hour:"2-digit",minute:"2-digit"}):`${u}, ${m}`,y=()=>{const t=document.createElement("iframe");t.style.position="fixed",t.style.right="0",t.style.bottom="0",t.style.width="0",t.style.height="0",t.style.border="0",document.body.appendChild(t);const b=t.contentWindow?.document;if(!b){window.print();return}const I=`
      ...
      <html>
        ...
        <body>
            ...
            ${p?.kop?.logoUrl?`<div style="flex-shrink: 0;"><img src="${p.kop.logoUrl}" style="height: 65px; width: auto; object-fit: contain;" alt="Logo" /></div>`:""}
            <div style="text-align: center; flex: 1;">
              <div style="font-size: 13.5pt; font-weight: 900; color: #000; letter-spacing: 0.5px; text-transform: uppercase; margin-bottom: 2px;">${p?.kop?.clinicName||"PT NAVENA INTERNATIONAL GROUP"}</div>
              <div style="font-size: 8.5pt; font-weight: 500; color: #222; margin-bottom: 2px;">Phone: ${p?.kop?.phone||"+62 21 555 1900"} &nbsp; E-mail: <span style="color: #0056b3; text-decoration: underline;">${p?.kop?.email||"navenainternationalgroup@gmail.com"}</span></div>
              <div style="font-size: 8pt; color: #333; line-height: 1.3;">${p?.kop?.address||"Jl. Sapta Taruna Raya No.7, Desa/Kelurahan Pondok Pinang, Kec. Kebayoran Lama, Kota Adm. Jakarta Selatan"}</div>
            </div>
          </div>
          ...
          <div class="doc-header">
            ...
            <div class="doc-ref">Nomor Dokumen: SK-CONSENT-${l} • Lembar Informed Consent Resmi</div>
          </div>

          <div class="meta-box">
            <div>
              <div class="meta-item"><span class="meta-label">Nama Pasien:</span> <span class="meta-value">${r}</span> (${c?"Guest":"Member"})</div>
              <div class="meta-item"><span class="meta-label">No. Telepon/WA:</span> <span class="meta-value">${k||"-"}</span></div>
              <div class="meta-item"><span class="meta-label">Layanan Tindakan:</span> <span class="meta-value">${g}</span></div>
            </div>
            <div>
              <div class="meta-item"><span class="meta-label">Dokter Bertugas:</span> <span class="meta-value">${h}</span></div>
              <div class="meta-item"><span class="meta-label">Jadwal Praktik:</span> <span class="meta-value">${u} • ${m}</span></div>
