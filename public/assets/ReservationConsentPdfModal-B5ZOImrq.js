import{d as sa,r as i,j as a,B as j,X as Y}from"./index-DNqLButQ.js";import{r as O}from"./index-BTiJGnWx.js";import{g as q}from"./clinicSettingsApi-ClnOouUi.js";import{F as Q}from"./file-text-C_YTRySZ.js";import{P as V}from"./printer-Bi37La1l.js";import{C as H}from"./check-leLBXHL1.js";const ia=[["path",{d:"M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8",key:"1357e3"}],["path",{d:"M3 3v5h5",key:"1xhq8a"}]],ga=sa("rotate-ccw",ia);function xa({isOpen:g,onClose:d,onAccept:v,initialName:l="",initialEmail:x="",initialPhone:w="",initialSignature:Z,isAgreed:h=!1,showAcceptButton:S=!0,readOnly:I}){const z=I||!v||!S,[r,k]=i.useState(null),[J,N]=i.useState(null),[c,A]=i.useState(l),[M,T]=i.useState(h),[R,b]=i.useState(null);i.useEffect(()=>{l&&A(l),T(h)},[l,h]),i.useEffect(()=>{g&&(b(null),q().then(t=>{t.pdf_terms_and_conditions&&N(t.pdf_terms_and_conditions),t.booking_terms&&t.booking_terms.trim().length>0&&k(t.booking_terms)}).catch(()=>{}))},[g]);const y=()=>{if(!M){b("Harap centang kotak persetujuan Syarat dan Ketentuan.");return}if(!c.trim()){b("Harap lengkapi nama Anda.");return}v&&v(c.trim()),d()},K=()=>{const t=document.createElement("iframe");t.style.position="fixed",t.style.right="0",t.style.bottom="0",t.style.width="0",t.style.height="0",t.style.border="0",document.body.appendChild(t);const f=t.contentWindow?.document;if(!f){window.print();return}const _=`
      <!DOCTYPE html>
      <html>
        <head>
          <meta charset="utf-8" />
