import{c as L,A as ia,r as i,j as a,B as C,X as F}from"./index-_BNpNnit.js";import{D as U,a as V,b as X,f as ra}from"./dialog-C9XJSy8p.js";import{F as Y}from"./index-Bt8z-swr.js";import{C as q}from"./check-De1HkNN6.js";const la=[["path",{d:"M7.9 20A9 9 0 1 0 4 16.1L2 22Z",key:"vv11sd"}]],pa=L("message-circle",la);const da=[["path",{d:"M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2",key:"143wyd"}],["path",{d:"M6 9V3a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1v6",key:"1itne7"}],["rect",{x:"6",y:"14",width:"12",height:"8",rx:"1",key:"1ue0tg"}]],Z=L("printer",da);const oa=[["path",{d:"M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8",key:"1357e3"}],["path",{d:"M3 3v5h5",key:"1xhq8a"}]],ha=L("rotate-ccw",oa);async function Q(){const r=await fetch(`${ia}/public/settings`,{headers:{Accept:"application/json"}});return r.ok?r.json():{}}function ka({isOpen:r,onClose:m,onAccept:w,initialName:l="",initialEmail:g="",initialPhone:b="",initialSignature:aa,isAgreed:p=!1,showAcceptButton:I=!0}){const[B,D]=i.useState(null),[d,N]=i.useState(null),[x,y]=i.useState(l),[K,A]=i.useState(p),[E,h]=i.useState(null);i.useEffect(()=>{l&&y(l),A(p)},[l,p]),i.useEffect(()=>{r&&(h(null),Q().then(s=>{s.pdf_terms_and_conditions&&N(s.pdf_terms_and_conditions),s.booking_terms&&s.booking_terms.trim().length>0&&D(s.booking_terms)}).catch(()=>{}))},[r]);const f=()=>{if(!K){h("Harap centang kotak persetujuan Syarat dan Ketentuan.");return}if(!x.trim()){h("Harap lengkapi nama Anda.");return}w&&w(x.trim()),m()},P=()=>{const s=document.createElement("iframe");s.style.position="fixed",s.style.right="0",s.style.bottom="0",s.style.width="0",s.style.height="0",s.style.border="0",document.body.appendChild(s);const k=s.contentWindow?.document;if(!k){window.print();return}const _=`
      <!DOCTYPE html>
      <html>
        <head>
          <meta charset="utf-8" />
