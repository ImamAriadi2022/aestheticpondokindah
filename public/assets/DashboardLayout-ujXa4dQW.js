import{x as re,a0 as F,r as i,n as W,q as G,j as e,b as q,a as b,U as Q,u as ne,o as oe,D as le,E as ie}from"./index-DgUGgJNO.js";import{c as B,S as H,L as J,N as de,A as ce,U as xe,D as be,a as ue}from"./NewMobileDashboardLayout-w66DoH68.js";import{C as L}from"./message-square-DF2tCu41.js";import{U as I}from"./users-CEYowfu6.js";import{F as Z}from"./file-text-B-yN3C19.js";import{D as V}from"./download-DTvKR-vs.js";import{C as he}from"./chevron-down-llHgxbd9.js";const pe=[{label:"Blog",href:"/dashboard/clinic?tab=content-blog"},{label:"Promo",href:"/dashboard/clinic?tab=content-promo"},{label:"Pop Up",href:"/dashboard/clinic?tab=content-popup"},{label:"Galeri",href:"/dashboard/clinic?tab=content-gallery"},{label:"Testimoni",href:"/dashboard/clinic?tab=content-testimonials"},{label:"Daftar Aplikasi Mobile",href:"/dashboard/clinic?tab=content-download"}],me=[{label:"Booking",href:"/dashboard/clinic?tab=reservasi"},{label:"Konsultasi",href:"/dashboard/clinic?tab=konsultasi"},{label:"Pengaduan",href:"/dashboard/clinic?tab=pengaduan"}],fe=[{label:"Pengguna",href:"/dashboard/clinic?tab=users"},{label:"Dokter",href:"/dashboard/clinic?tab=doctors"},{label:"Membership",href:"/dashboard/clinic/membership"}],ge={root:{[F.USER]:[{label:"Dashboard",icon:B,href:"/dashboard/user"},{label:"Konsultasi",icon:L,href:"/dashboard/user?tab=konsultasi"},{label:"Pengaduan",icon:re,href:"/dashboard/user?tab=pengaduan"}],[F.CLINIC]:[{label:"Dashboard",icon:B,href:"/dashboard/clinic"},{label:"Sistem Booking",icon:L,href:"/dashboard/clinic?tab=reservasi",submenu:me},{label:"Konten",icon:Z,href:"/dashboard/clinic?tab=content-blog",submenu:pe},{label:"Kelola Pengguna",icon:I,href:"/dashboard/clinic?tab=users",submenu:fe}],[F.DOCTOR]:[{label:"Dashboard",icon:B,href:"/dashboard/doctor"},{label:"Jadwal Praktik",icon:L,href:"/dashboard/doctor?tab=jadwal"},{label:"Daftar Pasien",icon:I,href:"/dashboard/doctor?tab=reservasi"}]}};function X(p){return ge.root[p]??[]}function ve({onLogout:p}){const[s,m]=i.useState(!1),[u,f]=i.useState(!1),l=i.useRef(null),v=i.useRef(null),A=W(),r=G();i.useEffect(()=>{const n=o=>{l.current&&!l.current.contains(o.target)&&v.current&&!v.current.contains(o.target)&&f(!1)};return document.addEventListener("mousedown",n),()=>document.removeEventListener("mousedown",n)},[]);const k=()=>{m(n=>!n),f(!1)},C=()=>{m(!1),f(!1)},E=n=>{const o=A.pathname,j=new URLSearchParams(A.search).get("tab"),[N,_]=n.split("?");if(o!==N)return!1;const h=_?new URLSearchParams(_).get("tab"):null;return h?j===h:!j},D=X("doctor");return e.jsx("div",{className:"sticky top-4 left-0 h-[calc(100vh-32px)] self-start z-[100] pointer-events-auto ml-2 mr-2 flex-shrink-0",children:e.jsxs("aside",{className:`
        ...
        `,children:[e.jsx("div",{className:"absolute inset-0 rounded-[28px] bg-gradient-to-br from-[#C9A24A]/10 via-transparent to-[#B8943F]/10 pointer-events-none"}),e.jsx("div",{className:"absolute inset-[1px] rounded-[27px] border border-[#C9A24A]/10 pointer-events-none"}),e.jsx("div",{className:"relative z-10 flex items-center justify-center h-16 px-4",children:e.jsx("button",{onClick:k,className:`
            ...
            `,children:[e.jsx("div",{className:"absolute inset-0 rounded-[28px] bg-gradient-to-br from-[#C9A24A]/10 via-transparent to-[#B8943F]/10 pointer-events-none"}),e.jsx("div",{className:"absolute inset-[1px] rounded-[27px] border border-[#C9A24A]/10 pointer-events-none"}),e.jsx("div",{className:"relative z-10 flex items-center justify-center h-16 px-4",children:e.jsx("button",{onClick:_,className:`
                ...
                `,"aria-label":l?"Tutup sidebar":"Buka sidebar",children:e.jsx(q,{className:"w-5 h-5",strokeWidth:2.5})})}),e.jsx("div",{className:"mx-5 h-px bg-gradient-to-r from-transparent via-[#C9A24A]/40 to-transparent"}),e.jsx("nav",{className:"relative z-10 flex-1 flex flex-col gap-2 px-3 py-4",children:ae.map(t=>{const c=U(t.href);if(s==="clinic"&&!!t.submenu?.length){const x=t.submenu.some(d=>U(d.href));return e.jsxs("button",{type:"button",onClick:d=>{const g=!A||k!==t.submenu;if(g){const K=d.currentTarget.getBoundingClientRect();D({top:K.top,left:K.right+12})}g&&!x&&$(t.href),C(t.submenu||[]),r(g)},className:`
                        group relative flex items-center
                  ...
                  `,children:[e.jsx("p",{className:"text-sm font-semibold text-[#E8C547] whitespace-nowrap",children:a?.name||"Admin Klinik"}),e.jsx("p",{className:"text-xs text-[#A89F91] whitespace-nowrap",children:"Admin Klinik"})]}),!l&&!n&&e.jsxs("div",{className:`
                    ...
                    `,children:[e.jsx("p",{className:"font-semibold",children:a?.name||"Admin Klinik"}),e.jsx("p",{className:"text-xs text-[#A89F91]",children:"Admin Klinik"}),e.jsx("div",{className:"absolute left-0 top-1/2 -translate-x-1 -translate-y-1/2 w-2 h-2 bg-[#1a1612] border-l border-t border-[#C9A24A]/40 rotate-45"})]})]}),n&&e.jsxs("div",{ref:j,className:`
                      ...
                      p-4 z-50
                      transition-all duration-200 ease-out
                    `,children:[e.jsxs("div",{className:"flex items-center gap-3 pb-3 border-b border-[#C9A24A]/20",children:[a?.avatar?e.jsx("img",{src:a.avatar.includes("storage/data:image")?a.avatar.substring(a.avatar.indexOf("data:image")):a.avatar,alt:a?.name||"User",className:"w-11 h-11 rounded-full object-cover shadow-md shrink-0 border border-[#C9A24A]"}):e.jsx("div",{className:"w-11 h-11 rounded-full bg-gradient-to-br from-[#E8C547] to-[#B8943F] flex items-center justify-center text-[#1a1612] font-bold text-base shadow-md shrink-0",children:(a?.name||"U").charAt(0).toUpperCase()}),e.jsxs("div",{className:"overflow-hidden min-w-0",children:[e.jsx("p",{className:"text-sm font-bold text-[#E8C547] truncate",children:a?.name||"User"}),e.jsx("p",{className:"text-xs text-[#A89F91] truncate",children:a?.email||""})]})]}),e.jsxs("div",{className:"pt-2 space-y-1",children:[s==="clinic"&&e.jsxs(b,{to:"/dashboard/clinic?tab=settings",onClick:()=>{o(!1),h()},className:"flex items-center gap-3 px-3 py-2.5 rounded-xl text-xs font-bold text-[#E8C547] bg-[#C9A24A]/20 hover:bg-[#C9A24A]/30 transition-all mb-1 border border-[#C9A24A]/30",children:[e.jsx(Z,{className:"w-4 h-4 text-[#C9A24A]"}),"Pengaturan Klinik"]}),e.jsxs(b,{to:"/profile",onClick:()=>{o(!1),h()},className:"flex items-center gap-3 px-3 py-2.5 rounded-xl text-xs font-semibold text-[#D4C5B0] hover:text-[#E8C547] hover:bg-[#2a2319] transition-all",children:[e.jsx(Q,{className:"w-4 h-4 text-[#C9A24A]"}),"Detail Profil"]}),e.jsxs(b,{to:"/settings",onClick:()=>{o(!1),h()},className:"flex items-center gap-3 px-3 py-2.5 rounded-xl text-xs font-semibold text-[#D4C5B0] hover:text-[#E8C547] hover:bg-[#2a2319] transition-all",children:[e.jsx(H,{className:"w-4 h-4 text-[#C9A24A]"}),"Preferensi"]}),e.jsxs(b,{to:s==="clinic"?"/dashboard/clinic?tab=content-download":"/download",onClick:()=>{o(!1),h()},className:"flex items-center gap-3 px-3 py-2.5 rounded-xl text-xs font-semibold text-[#D4C5B0] hover:text-[#E8C547] hover:bg-[#2a2319] transition-all",children:[s==="clinic"?e.jsx(xe,{className:"w-4 h-4 text-[#C9A24A]"}):e.jsx(V,{className:"w-4 h-4 text-[#C9A24A]"}),s==="clinic"?"Upload Aplikasi":"Download Aplikasi"]}),e.jsxs("button",{onClick:()=>{o(!1),P()},className:"w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-xs font-semibold text-rose-400 hover:text-rose-300 hover:bg-rose-500/10 transition-all text-left mt-1 border-t border-[#C9A24A]/10 pt-2",children:[e.jsx(J,{className:"w-4 h-4 text-rose-400"}),"Keluar Sesi"]})]})]})]})]})]}),A&&e.jsx("div",{className:"fixed z-[60] bg-[#1a1612] border border-[#C9A24A]/40 rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.5)] p-2 min-w-[180px] pointer-events-auto flex flex-col gap-1",style:{top:E.top,left:E.left},children:k?.map(t=>{const c=U(t.href);return e.jsxs(b,{to:t.href,onClick:h,className:`
                    ...
                    `,children:[e.jsx("span",{className:"w-1.5 h-1.5 rounded-full mr-2.5 bg-current"}),t.label]},t.label)})})]}),e.jsxs("div",{className:"flex-1 min-w-0 flex flex-col",children:[e.jsx(be,{role:s,navbarLabel:R}),e.jsxs("div",{className:"flex-1 flex min-h-0 bg-gray-50/50",children:[e.jsx("main",{className:"flex-1 min-w-0 pt-4 pb-6 px-4 sm:pt-5 sm:px-5 lg:pt-6 lg:px-6 overflow-y-auto transition-all duration-300",children:p}),!se&&e.jsx(ue,{session:a,navbarLabel:R,role:s,consultationsCount:m,activeTreatmentsCount:u,availableDoctorsCount:f})]})]})]})}export{Ue as D};
