import{c as y,A as K,r as o,j as e,B as p,X as N,C as w,U as R,S as L}from"./index-DMFwXh9x.js";import{D as C,a as A,b as D,e as E}from"./dialog-Bnlt1uiv.js";import{F as P}from"./file-text-wjfjSzJM.js";import{B}from"./building-2-B_ECb2LO.js";import{S as T}from"./shield-check-B84wZ_ok.js";import{S as M}from"./sparkles-C4MJzQQv.js";import{C as z}from"./message-square-BemPfjQL.js";import{C as $}from"./shield-DY462laP.js";const J=[["path",{d:"M7.9 20A9 9 0 1 0 4 16.1L2 22Z",key:"vv11sd"}]],Z=y("message-circle",J);const U=[["path",{d:"M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2",key:"143wyd"}],["path",{d:"M6 9V3a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1v6",key:"1itne7"}],["rect",{x:"6",y:"14",width:"12",height:"8",rx:"1",key:"1ue0tg"}]],f=y("printer",U);async function F(){const i=await fetch(`${K}/public/settings`,{headers:{Accept:"application/json"}});return i.ok?i.json():{}}function q({isOpen:i,onClose:s,onAccept:d,showAcceptButton:r=!1}){const[b,c]=o.useState(null),[k,x]=o.useState(null),[h,m]=o.useState(!1);o.useEffect(()=>{i&&(m(!0),F().then(a=>{a.pdf_terms_and_conditions&&x(a.pdf_terms_and_conditions),a.booking_terms&&a.booking_terms.trim().length>0&&c(a.booking_terms)}).catch(()=>{}).finally(()=>m(!1)))},[i]);const l=()=>{const a=document.createElement("iframe");a.style.position="fixed",a.style.right="0",a.style.bottom="0",a.style.width="0",a.style.height="0",a.style.border="0",document.body.appendChild(a);const n=a.contentWindow?.document;if(!n){window.print();return}const g=`
      <!DOCTYPE html>
      <html>
        <head>
          <meta charset="utf-8" />
      ...
      <html>
        ...
        <body>
          ...
          <div class="meta-box">
            ...
            <div>
              <div class="meta-item"><span class="meta-label">Dokter Bertugas:</span> <span class="meta-value">${x}</span></div>
              <div class="meta-item"><span class="meta-label">Jadwal Praktik:</span> <span class="meta-value">${h} • ${m}</span></div>
