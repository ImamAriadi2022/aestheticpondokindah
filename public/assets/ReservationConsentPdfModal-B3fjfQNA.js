import{c as w,A as z,r as c,j as e,B as h,X as D,C as A,U as M,S as U}from"./index-BDJ-FHBc.js";import{D as P,a as E,b as T,f as F}from"./dialog-BLRlxAdX.js";import{F as B}from"./file-text-DnhfD0Qj.js";import{B as _}from"./building-2-IUFBECLc.js";import{S}from"./shield-check-8ONftUSM.js";import{S as W}from"./sparkles-DmKB7iYf.js";import{C as J}from"./message-square-B4v9KGlw.js";import{C as H}from"./clock-CvHY-rvE.js";const O=[["path",{d:"M7.9 20A9 9 0 1 0 4 16.1L2 22Z",key:"vv11sd"}]],se=w("message-circle",O);const G=[["path",{d:"M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2",key:"143wyd"}],["path",{d:"M6 9V3a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1v6",key:"1itne7"}],["rect",{x:"6",y:"14",width:"12",height:"8",rx:"1",key:"1ue0tg"}]],N=w("printer",G);const V=[["path",{d:"M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8",key:"1357e3"}],["path",{d:"M3 3v5h5",key:"1xhq8a"}]],ne=w("rotate-ccw",V);async function K(){const i=await fetch(`${z}/public/settings`,{headers:{Accept:"application/json"}});return i.ok?i.json():{}}function ie({isOpen:i,onClose:l,onAccept:m,showAcceptButton:r=!1}){const[j,p]=c.useState(null),[t,g]=c.useState(null),[b,x]=c.useState(!1);c.useEffect(()=>{i&&(x(!0),K().then(s=>{s.pdf_terms_and_conditions&&g(s.pdf_terms_and_conditions),s.booking_terms&&s.booking_terms.trim().length>0&&p(s.booking_terms)}).catch(()=>{}).finally(()=>x(!1)))},[i]);const d=()=>{const s=document.createElement("iframe");s.style.position="fixed",s.style.right="0",s.style.bottom="0",s.style.width="0",s.style.height="0",s.style.border="0",document.body.appendChild(s);const o=s.contentWindow?.document;if(!o){window.print();return}const v=t?.kop?.logoWidth||75,a=t?.kop?.logoHeight||75,y=t?.bodyHtml||(t?.sections&&t.sections.length>0?t.sections.map(u=>`
