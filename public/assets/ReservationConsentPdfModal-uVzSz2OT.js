import{c as v,A as K,r as p,j as e,B as o,X as y,C as N,U as S,S as R}from"./index-xTZj0FHB.js";import{D as w,a as C,b as A,e as D}from"./dialog-CTPpzAme.js";import{F as E}from"./file-text-Bj-q3roD.js";import{B as P}from"./building-2-dFbxck-h.js";import{S as B}from"./shield-check-BdQbfVS2.js";import{S as L}from"./sparkles-CtoRw7u_.js";import{C as M}from"./message-square-DCfEPrfZ.js";import{C as z}from"./shield-B_PKMj0c.js";const $=[["path",{d:"M7.9 20A9 9 0 1 0 4 16.1L2 22Z",key:"vv11sd"}]],V=v("message-circle",$);const J=[["path",{d:"M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2",key:"143wyd"}],["path",{d:"M6 9V3a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1v6",key:"1itne7"}],["rect",{x:"6",y:"14",width:"12",height:"8",rx:"1",key:"1ue0tg"}]],g=v("printer",J);async function T(){const i=await fetch(`${K}/public/settings`,{headers:{Accept:"application/json"}});return i.ok?i.json():{}}function X({isOpen:i,onClose:s,onAccept:d,showAcceptButton:r=!1}){const[b,l]=p.useState(null),[k,c]=p.useState(!1);p.useEffect(()=>{i&&(c(!0),T().then(a=>{a.booking_terms&&a.booking_terms.trim().length>0&&l(a.booking_terms)}).catch(()=>{}).finally(()=>c(!1)))},[i]);const m=()=>{const a=document.createElement("iframe");a.style.position="fixed",a.style.right="0",a.style.bottom="0",a.style.width="0",a.style.height="0",a.style.border="0",document.body.appendChild(a);const n=a.contentWindow?.document;if(!n){window.print();return}const x=`
      <!DOCTYPE html>
      <html>
        <head>
          <meta charset="utf-8" />
