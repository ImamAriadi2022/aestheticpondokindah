import{c as H,A as ia,r as i,j as a,B as j,X as O}from"./index-Dmhsj1IT.js";import{r as q,F as V}from"./index-CUA6pwUt.js";import{C as W}from"./check-WjAAAz_X.js";const ra=[["path",{d:"M7.9 20A9 9 0 1 0 4 16.1L2 22Z",key:"vv11sd"}]],ga=H("message-circle",ra);const la=[["path",{d:"M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2",key:"143wyd"}],["path",{d:"M6 9V3a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1v6",key:"1itne7"}],["rect",{x:"6",y:"14",width:"12",height:"8",rx:"1",key:"1ue0tg"}]],Z=H("printer",la);const da=[["path",{d:"M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8",key:"1357e3"}],["path",{d:"M3 3v5h5",key:"1xhq8a"}]],xa=H("rotate-ccw",da);async function Q(){const d=await fetch(`${ia}/public/settings`,{headers:{Accept:"application/json"}});return d.ok?d.json():{}}function pa({isOpen:d,onClose:o,onAccept:v,initialName:l="",initialEmail:x="",initialPhone:w="",initialSignature:aa,isAgreed:h=!1,showAcceptButton:S=!0,readOnly:D}){const M=D||!v||!S,[r,k]=i.useState(null),[J,N]=i.useState(null),[u,A]=i.useState(l),[z,T]=i.useState(h),[R,b]=i.useState(null);i.useEffect(()=>{l&&A(l),T(h)},[l,h]),i.useEffect(()=>{d&&(b(null),Q().then(t=>{t.pdf_terms_and_conditions&&N(t.pdf_terms_and_conditions),t.booking_terms&&t.booking_terms.trim().length>0&&k(t.booking_terms)}).catch(()=>{}))},[d]);const y=()=>{if(!z){b("Harap centang kotak persetujuan Syarat dan Ketentuan.");return}if(!u.trim()){b("Harap lengkapi nama Anda.");return}v&&v(u.trim()),o()},K=()=>{const t=document.createElement("iframe");t.style.position="fixed",t.style.right="0",t.style.bottom="0",t.style.width="0",t.style.height="0",t.style.border="0",document.body.appendChild(t);const f=t.contentWindow?.document;if(!f){window.print();return}const $=`
      <!DOCTYPE html>
      <html>
        <head>
          <meta charset="utf-8" />
          ...
          <div class="signature-section">
            <div class="sig-row">
              ...
              <div class="sig-box">
                ...
                ${P?`<img src="${c.current?.toDataURL("image/png")}" class="sig-img" alt="Tanda Tangan" />`:r?`<img src="${r}" class="sig-img" alt="Tanda Tangan" />`:'<div style="height: 45px;"></div>'}
