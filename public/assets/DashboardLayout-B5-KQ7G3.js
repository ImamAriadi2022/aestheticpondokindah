import{s as I,K as F,r as i,k as G,n as q,j as e,a as b,U as Q,u as re,m as ne,v as oe,w as le}from"./index-C88bqciP.js";import{b as B,S as M,L as H,N as ie,A as de,U as ce,D as xe}from"./NewMobileDashboardLayout-B-zynJNi.js";import{C as L,M as be}from"./message-square-CwMGdKiL.js";import{U as W}from"./users-GrUg5KHP.js";import{F as ue}from"./file-text-CgkFJjaV.js";import{S as he}from"./stethoscope-DxwXZ524.js";import{C as J}from"./chevron-right-BYGA5b30.js";import{P as pe}from"./pencil-DnO5l8sp.js";import{D as Z}from"./download-CwCXKQ0C.js";import{C as me}from"./chevron-down-BqM0Jl3-.js";const fe=[{label:"Blog",href:"/dashboard/clinic?tab=content-blog"},{label:"Promo",href:"/dashboard/clinic?tab=content-promo"},{label:"Pop Up",href:"/dashboard/clinic?tab=content-popup"},{label:"Galeri",href:"/dashboard/clinic?tab=content-gallery"},{label:"Testimoni",href:"/dashboard/clinic?tab=content-testimonials"},{label:"Daftar Aplikasi Mobile",href:"/dashboard/clinic?tab=content-download"}],ge=[{label:"Reservasi",href:"/dashboard/clinic?tab=reservasi"},{label:"Konsultasi",href:"/dashboard/clinic?tab=konsultasi"}],ve=[{label:"Daftar Pengguna",href:"/dashboard/clinic?tab=users"},{label:"Membership",href:"/dashboard/clinic/membership"}],Ae={root:{[F.USER]:[{label:"Dashboard",icon:B,href:"/dashboard/user"},{label:"Konsultasi",icon:L,href:"/dashboard/user?tab=konsultasi"},{label:"Pengaduan",icon:I,href:"/dashboard/user?tab=pengaduan"}],[F.CLINIC]:[{label:"Dashboard",icon:B,href:"/dashboard/clinic"},{label:"Sistem Booking",icon:L,href:"/dashboard/clinic?tab=reservasi",submenu:ge},{label:"Pengaduan",icon:I,href:"/dashboard/clinic?tab=pengaduan"},{label:"Konten",icon:ue,href:"/dashboard/clinic?tab=content-blog",submenu:fe},{label:"Kelola Pengguna",icon:W,href:"/dashboard/clinic?tab=users",submenu:ve},{label:"Dokter",icon:he,href:"/dashboard/clinic?tab=doctors"},{label:"Pengaturan Klinik",icon:M,href:"/dashboard/clinic?tab=settings"}],[F.DOCTOR]:[{label:"Dashboard",icon:B,href:"/dashboard/doctor"},{label:"Jadwal Praktik",icon:L,href:"/dashboard/doctor?tab=jadwal"},{label:"Reservasi Pasien",icon:W,href:"/dashboard/doctor?tab=reservasi"},{label:"Konsultasi Online",icon:be,href:"/dashboard/doctor?tab=konsultasi"}]}};function V(h){return Ae.root[h]??[]}function Ce({onLogout:h}){const[s,p]=i.useState(!1),[u,f]=i.useState(!1),l=i.useRef(null),A=i.useRef(null),C=G(),r=q();i.useEffect(()=>{const n=o=>{l.current&&!l.current.contains(o.target)&&A.current&&!A.current.contains(o.target)&&f(!1)};return document.addEventListener("mousedown",n),()=>document.removeEventListener("mousedown",n)},[]);const k=()=>{p(n=>!n),f(!1)},g=()=>{p(!1),f(!1)},E=n=>{const o=C.pathname,j=new URLSearchParams(C.search).get("tab"),[N,_]=n.split("?");if(o!==N)return!1;const m=_?new URLSearchParams(_).get("tab"):null;return m?j===m:!j},D=V("doctor");return e.jsx("div",{className:"sticky top-4 left-0 h-[calc(100vh-32px)] self-start z-[100] pointer-events-auto ml-2 mr-2 flex-shrink-0",children:e.jsxs("aside",{className:`
        ...
        `,children:[e.jsx("div",{className:"absolute inset-0 rounded-[28px] bg-gradient-to-br from-[#C9A24A]/10 via-transparent to-[#B8943F]/10 pointer-events-none"}),e.jsx("div",{className:"absolute inset-[1px] rounded-[27px] border border-[#C9A24A]/10 pointer-events-none"}),e.jsx("div",{className:"relative z-10 flex items-center justify-center h-16 px-4",children:e.jsx("button",{onClick:k,className:`
            ...
            `,children:[e.jsx("div",{className:"absolute inset-0 rounded-[28px] bg-gradient-to-br from-[#C9A24A]/10 via-transparent to-[#B8943F]/10 pointer-events-none"}),e.jsx("div",{className:"absolute inset-[1px] rounded-[27px] border border-[#C9A24A]/10 pointer-events-none"}),e.jsx("div",{className:"relative z-10 flex items-center justify-center h-16 px-4",children:e.jsx("button",{onClick:_,className:`
                ...
                `,"aria-label":l?"Tutup sidebar":"Buka sidebar",children:e.jsx(J,{className:"w-5 h-5",strokeWidth:2.5})})}),e.jsx("div",{className:"mx-5 h-px bg-gradient-to-r from-transparent via-[#C9A24A]/40 to-transparent"}),e.jsx("nav",{className:"relative z-10 flex-1 flex flex-col gap-2 px-3 py-4",children:ae.map(t=>{const c=U(t.href);if(s==="clinic"&&!!t.submenu?.length){const x=t.submenu.some(d=>U(d.href));return e.jsxs("button",{type:"button",onClick:d=>{const v=!C||k!==t.submenu;if(v){const T=d.currentTarget.getBoundingClientRect();D({top:T.top,left:T.right+12})}v&&!x&&$(t.href),g(t.submenu||[]),r(v)},className:`
                        group relative flex items-center
                      ...
                      `,children:e.jsx(t.icon,{className:"w-[18px] h-[18px]",strokeWidth:x?2.5:2})}),l&&e.jsxs(e.Fragment,{children:[e.jsx("span",{className:`
                          ...
                          shadow-[0_4px_20px_rgba(0,0,0,0.3)]
                          z-50
                        `,children:[t.label,e.jsx("div",{className:"absolute left-0 top-1/2 -translate-x-1 -translate-y-1/2 w-2 h-2 bg-[#1a1612] border-l border-t border-[#C9A24A]/40 rotate-45"})]})]},t.label)}return e.jsxs(b,{to:t.href,onClick:m,className:`
                      group relative flex items-center
                      h-12 rounded-2xl
                      transition-all duration-300 ease-out
                  ...
                  `,children:[e.jsx("p",{className:"text-sm font-semibold text-[#E8C547] whitespace-nowrap",children:a?.name||"Admin Klinik"}),e.jsx("p",{className:"text-xs text-[#A89F91] whitespace-nowrap",children:"Admin Klinik"})]}),!l&&!n&&e.jsxs("div",{className:`
                    ...
                    `,children:[e.jsx("p",{className:"font-semibold",children:a?.name||"Admin Klinik"}),e.jsx("p",{className:"text-xs text-[#A89F91]",children:"Admin Klinik"}),e.jsx("div",{className:"absolute left-0 top-1/2 -translate-x-1 -translate-y-1/2 w-2 h-2 bg-[#1a1612] border-l border-t border-[#C9A24A]/40 rotate-45"})]})]}),n&&e.jsxs("div",{ref:j,className:`
                      ...
                      p-4 z-50
                      transition-all duration-200 ease-out
                    `,children:[e.jsxs("div",{className:"flex items-center gap-3 pb-3 border-b border-[#C9A24A]/20",children:[a?.avatar?e.jsx("img",{src:a.avatar.includes("storage/data:image")?a.avatar.substring(a.avatar.indexOf("data:image")):a.avatar,alt:a?.name||"User",className:"w-11 h-11 rounded-full object-cover shadow-md shrink-0 border border-[#C9A24A]"}):e.jsx("div",{className:"w-11 h-11 rounded-full bg-gradient-to-br from-[#E8C547] to-[#B8943F] flex items-center justify-center text-[#1a1612] font-bold text-base shadow-md shrink-0",children:(a?.name||"U").charAt(0).toUpperCase()}),e.jsxs("div",{className:"overflow-hidden min-w-0",children:[e.jsx("p",{className:"text-sm font-bold text-[#E8C547] truncate",children:a?.name||"User"}),e.jsx("p",{className:"text-xs text-[#A89F91] truncate",children:a?.email||""})]})]}),e.jsxs("div",{className:"pt-2 space-y-1",children:[e.jsxs(b,{to:"/profile",onClick:()=>{o(!1),m()},className:"flex items-center gap-3 px-3 py-2.5 rounded-xl text-xs font-semibold text-[#D4C5B0] hover:text-[#E8C547] hover:bg-[#2a2319] transition-all",children:[e.jsx(Q,{className:"w-4 h-4 text-[#C9A24A]"}),"Detail Profil"]}),e.jsxs(b,{to:"/settings",onClick:()=>{o(!1),m()},className:"flex items-center gap-3 px-3 py-2.5 rounded-xl text-xs font-semibold text-[#D4C5B0] hover:text-[#E8C547] hover:bg-[#2a2319] transition-all",children:[e.jsx(M,{className:"w-4 h-4 text-[#C9A24A]"}),"Preferensi"]}),e.jsxs(b,{to:s==="clinic"?"/dashboard/clinic?tab=content-download":"/download",onClick:()=>{o(!1),m()},className:"flex items-center gap-3 px-3 py-2.5 rounded-xl text-xs font-semibold text-[#D4C5B0] hover:text-[#E8C547] hover:bg-[#2a2319] transition-all",children:[s==="clinic"?e.jsx(ce,{className:"w-4 h-4 text-[#C9A24A]"}):e.jsx(Z,{className:"w-4 h-4 text-[#C9A24A]"}),s==="clinic"?"Upload Aplikasi":"Download Aplikasi"]}),e.jsxs("button",{onClick:()=>{o(!1),P()},className:"w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-xs font-semibold text-rose-400 hover:text-rose-300 hover:bg-rose-500/10 transition-all text-left mt-1 border-t border-[#C9A24A]/10 pt-2",children:[e.jsx(H,{className:"w-4 h-4 text-rose-400"}),"Keluar Sesi"]})]})]})]})]})]}),C&&e.jsx("div",{className:"fixed z-[60] bg-[#1a1612] border border-[#C9A24A]/40 rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.5)] p-2 min-w-[180px] pointer-events-auto flex flex-col gap-1",style:{top:E.top,left:E.left},children:k?.map(t=>{const c=U(t.href);return e.jsxs(b,{to:t.href,onClick:m,className:`
