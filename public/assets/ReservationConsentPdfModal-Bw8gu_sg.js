import{c as L,A as na,r as i,j as a,B as C,X as U}from"./index-Br9uRF4y.js";import{r as X,F as Y}from"./index-Bg90anb3.js";import{C as q}from"./check-ClsRqlIM.js";const sa=[["path",{d:"M7.9 20A9 9 0 1 0 4 16.1L2 22Z",key:"vv11sd"}]],ua=L("message-circle",sa);const ia=[["path",{d:"M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2",key:"143wyd"}],["path",{d:"M6 9V3a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1v6",key:"1itne7"}],["rect",{x:"6",y:"14",width:"12",height:"8",rx:"1",key:"1ue0tg"}]],O=L("printer",ia);const ra=[["path",{d:"M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8",key:"1357e3"}],["path",{d:"M3 3v5h5",key:"1xhq8a"}]],ma=L("rotate-ccw",ra);async function V(){const d=await fetch(`${na}/public/settings`,{headers:{Accept:"application/json"}});return d.ok?d.json():{}}function ga({isOpen:d,onClose:m,onAccept:w,initialName:r="",initialEmail:g="",initialPhone:b="",initialSignature:Z,isAgreed:p=!1,showAcceptButton:T=!0}){const[_,I]=i.useState(null),[l,N]=i.useState(null),[x,y]=i.useState(r),[D,P]=i.useState(p),[M,h]=i.useState(null);i.useEffect(()=>{r&&y(r),P(p)},[r,p]),i.useEffect(()=>{d&&(h(null),V().then(t=>{t.pdf_terms_and_conditions&&N(t.pdf_terms_and_conditions),t.booking_terms&&t.booking_terms.trim().length>0&&I(t.booking_terms)}).catch(()=>{}))},[d]);const f=()=>{if(!D){h("Harap centang kotak persetujuan Syarat dan Ketentuan.");return}if(!x.trim()){h("Harap lengkapi nama Anda.");return}w&&w(x.trim()),m()},A=()=>{const t=document.createElement("iframe");t.style.position="fixed",t.style.right="0",t.style.bottom="0",t.style.width="0",t.style.height="0",t.style.border="0",document.body.appendChild(t);const k=t.contentWindow?.document;if(!k){window.print();return}const H=`
      <!DOCTYPE html>
      <html>
        <head>
          <meta charset="utf-8" />
