import{o as T,J as S,r as l,h as W,m as q,j as e,a as b,U as J,u as oe,i as le,p as ie,q as de}from"./index-euMnukJc.js";import{b as F,C as ce,S as L,L as Q,N as xe,A as be,D as ue}from"./NewMobileDashboardLayout-CP92kZKd.js";import{C as B,M as K}from"./message-square-BNQNV0B4.js";import{U as I}from"./users-R-Sx5Y2e.js";import{F as he}from"./file-text-BOeecoR8.js";import{S as pe}from"./stethoscope-COYRgwug.js";import{C as G}from"./chevron-right-jvw_rfT4.js";import{P as H}from"./pencil-CvzddPEC.js";import{D as Z}from"./download-oRzAWDmW.js";import{C as me}from"./chevron-down-gqRXHl-F.js";const V=[{label:"Blog",href:"/dashboard/clinic?tab=content-blog"},{label:"Promo",href:"/dashboard/clinic?tab=content-promo"},{label:"Pop Up",href:"/dashboard/clinic?tab=content-popup"},{label:"Galeri",href:"/dashboard/clinic?tab=content-gallery"},{label:"Testimoni",href:"/dashboard/clinic?tab=content-testimonials"},{label:"Download App",href:"/dashboard/clinic?tab=content-download"}],fe={root:{[S.USER]:[{label:"Dashboard",icon:F,href:"/dashboard/user"},{label:"Konsultasi",icon:B,href:"/dashboard/user?tab=konsultasi"},{label:"Pengaduan",icon:T,href:"/dashboard/user?tab=pengaduan"}],[S.CLINIC]:[{label:"Dashboard",icon:F,href:"/dashboard/clinic"},{label:"Reservasi",icon:B,href:"/dashboard/clinic?tab=reservasi"},{label:"Konsultasi",icon:K,href:"/dashboard/clinic?tab=konsultasi"},{label:"Pengaduan",icon:T,href:"/dashboard/clinic?tab=pengaduan"},{label:"Konten",icon:he,href:"/dashboard/clinic?tab=content-blog",submenu:V},{label:"Pengguna",icon:I,href:"/dashboard/clinic?tab=users"},{label:"Membership",icon:ce,href:"/dashboard/clinic/membership"},{label:"Dokter",icon:pe,href:"/dashboard/clinic?tab=doctors"},{label:"Pengaturan",icon:L,href:"/dashboard/clinic?tab=settings"}],[S.DOCTOR]:[{label:"Dashboard",icon:F,href:"/dashboard/doctor"},{label:"Jadwal Praktik",icon:B,href:"/dashboard/doctor?tab=jadwal"},{label:"Reservasi Pasien",icon:I,href:"/dashboard/doctor?tab=reservasi"},{label:"Konsultasi Online",icon:K,href:"/dashboard/doctor?tab=konsultasi"}]}};function X(m){return fe.root[m]??[]}function ge({onLogout:m}){const[s,f]=l.useState(!1),[h,v]=l.useState(!1),o=l.useRef(null),C=l.useRef(null),A=W(),n=q();l.useEffect(()=>{const r=d=>{o.current&&!o.current.contains(d.target)&&C.current&&!C.current.contains(d.target)&&v(!1)};return document.addEventListener("mousedown",r),()=>document.removeEventListener("mousedown",r)},[]);const N=()=>{f(r=>!r),v(!1)},g=()=>{f(!1),v(!1)},_=r=>{const d=A.pathname,j=new URLSearchParams(A.search).get("tab"),[P,p]=r.split("?");if(d!==P)return!1;const u=p?new URLSearchParams(p).get("tab"):null;return u?j===u:!j},y=X("doctor");return e.jsx("div",{className:"sticky top-4 left-0 h-[calc(100vh-32px)] self-start z-[100] pointer-events-auto ml-2 mr-2 flex-shrink-0",children:e.jsxs("aside",{className:`
        ...
        `,children:[e.jsx("div",{className:"absolute inset-0 rounded-[28px] bg-gradient-to-br from-[#C9A24A]/10 via-transparent to-[#B8943F]/10 pointer-events-none"}),e.jsx("div",{className:"absolute inset-[1px] rounded-[27px] border border-[#C9A24A]/10 pointer-events-none"}),e.jsx("div",{className:"relative z-10 flex items-center justify-center h-16 px-4",children:e.jsx("button",{onClick:N,className:`
            ...
            `,"aria-label":s?"Tutup sidebar":"Buka sidebar",children:e.jsx(G,{className:"w-5 h-5",strokeWidth:2.5})})}),e.jsx("div",{className:"mx-5 h-px bg-gradient-to-r from-transparent via-[#C9A24A]/40 to-transparent"}),e.jsx("nav",{className:"relative z-10 flex-1 flex flex-col gap-2 px-3 py-4",children:y.map(r=>{const d=_(r.href);return e.jsxs(b,{to:r.href,onClick:g,className:`
              ...
              overflow-visible relative
              ${o?"w-[260px]":"w-[72px]"}
            `,children:[e.jsx("div",{className:"absolute inset-0 rounded-[28px] bg-gradient-to-br from-[#C9A24A]/10 via-transparent to-[#B8943F]/10 pointer-events-none"}),e.jsx("div",{className:"absolute inset-[1px] rounded-[27px] border border-[#C9A24A]/10 pointer-events-none"}),e.jsx("div",{className:"relative z-10 flex items-center justify-center h-16 px-4",children:e.jsx("button",{onClick:P,className:`
                  flex items-center justify-center
                  w-10 h-10 rounded-xl
                  bg-[#2a2319] hover:bg-[#3a3126]
                  text-[#E8C547]
                ...
                `,"aria-label":o?"Tutup sidebar":"Buka sidebar",children:e.jsx(G,{className:"w-5 h-5",strokeWidth:2.5})})}),e.jsx("div",{className:"mx-5 h-px bg-gradient-to-r from-transparent via-[#C9A24A]/40 to-transparent"}),e.jsx("nav",{className:"relative z-10 flex-1 flex flex-col gap-2 px-3 py-4",children:se.map(t=>{const c=z(t.href);if(s==="clinic"&&t.label==="Konten"){const x=re();return e.jsxs("button",{ref:N,type:"button",onClick:()=>{const i=!A;if(i&&N.current){const w=N.current.getBoundingClientRect();_({top:w.top,left:w.right+12})}i&&!x&&U(t.href),n(i)},className:`
                        group relative flex items-center
