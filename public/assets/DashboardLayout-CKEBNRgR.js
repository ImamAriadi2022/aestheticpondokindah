import{o as I,J as U,r as i,h as q,m as G,j as e,a as b,U as J,u as ne,i as oe,p as le,q as ie}from"./index-CDluGSJ1.js";import{b as L,S as P,L as Q,N as de,A as ce,D as xe}from"./NewMobileDashboardLayout-YySxjzSS.js";import{C as $,M as be}from"./message-square-DnxHqK56.js";import{U as W}from"./users-l0Wj3pDc.js";import{F as ue}from"./file-text-Csq4NqdZ.js";import{S as he}from"./stethoscope-bjn380FZ.js";import{C as H}from"./chevron-right-zS0SJlc6.js";import{P as Z}from"./pencil-CJBOTAqr.js";import{D as V}from"./download-DIkMehyl.js";import{C as pe}from"./chevron-down-Bt-Dq76J.js";const me=[{label:"Blog",href:"/dashboard/clinic?tab=content-blog"},{label:"Promo",href:"/dashboard/clinic?tab=content-promo"},{label:"Pop Up",href:"/dashboard/clinic?tab=content-popup"},{label:"Galeri",href:"/dashboard/clinic?tab=content-gallery"},{label:"Testimoni",href:"/dashboard/clinic?tab=content-testimonials"},{label:"Download App",href:"/dashboard/clinic?tab=content-download"}],fe=[{label:"Reservasi",href:"/dashboard/clinic?tab=reservasi"},{label:"Konsultasi",href:"/dashboard/clinic?tab=konsultasi"}],ge=[{label:"Daftar Pengguna",href:"/dashboard/clinic?tab=users"},{label:"Membership",href:"/dashboard/clinic/membership"}],ve={root:{[U.USER]:[{label:"Dashboard",icon:L,href:"/dashboard/user"},{label:"Konsultasi",icon:$,href:"/dashboard/user?tab=konsultasi"},{label:"Pengaduan",icon:I,href:"/dashboard/user?tab=pengaduan"}],[U.CLINIC]:[{label:"Dashboard",icon:L,href:"/dashboard/clinic"},{label:"Sistem Booking",icon:$,href:"/dashboard/clinic?tab=reservasi",submenu:fe},{label:"Pengaduan",icon:I,href:"/dashboard/clinic?tab=pengaduan"},{label:"Konten",icon:ue,href:"/dashboard/clinic?tab=content-blog",submenu:me},{label:"Kelola Pengguna",icon:W,href:"/dashboard/clinic?tab=users",submenu:ge},{label:"Dokter",icon:he,href:"/dashboard/clinic?tab=doctors"},{label:"Pengaturan Klinik",icon:P,href:"/dashboard/clinic?tab=settings"},{label:"Preferensi",icon:P,href:"/settings"}],[U.DOCTOR]:[{label:"Dashboard",icon:L,href:"/dashboard/doctor"},{label:"Jadwal Praktik",icon:$,href:"/dashboard/doctor?tab=jadwal"},{label:"Reservasi Pasien",icon:W,href:"/dashboard/doctor?tab=reservasi"},{label:"Konsultasi Online",icon:be,href:"/dashboard/doctor?tab=konsultasi"}]}};function X(p){return ve.root[p]??[]}function Ce({onLogout:p}){const[s,m]=i.useState(!1),[u,f]=i.useState(!1),l=i.useRef(null),C=i.useRef(null),A=q(),r=G();i.useEffect(()=>{const n=o=>{l.current&&!l.current.contains(o.target)&&C.current&&!C.current.contains(o.target)&&f(!1)};return document.addEventListener("mousedown",n),()=>document.removeEventListener("mousedown",n)},[]);const k=()=>{m(n=>!n),f(!1)},g=()=>{m(!1),f(!1)},E=n=>{const o=A.pathname,j=new URLSearchParams(A.search).get("tab"),[N,_]=n.split("?");if(o!==N)return!1;const h=_?new URLSearchParams(_).get("tab"):null;return h?j===h:!j},D=X("doctor");return e.jsx("div",{className:"sticky top-4 left-0 h-[calc(100vh-32px)] self-start z-[100] pointer-events-auto ml-2 mr-2 flex-shrink-0",children:e.jsxs("aside",{className:`
        ...
        `,children:[e.jsx("div",{className:"absolute inset-0 rounded-[28px] bg-gradient-to-br from-[#C9A24A]/10 via-transparent to-[#B8943F]/10 pointer-events-none"}),e.jsx("div",{className:"absolute inset-[1px] rounded-[27px] border border-[#C9A24A]/10 pointer-events-none"}),e.jsx("div",{className:"relative z-10 flex items-center justify-center h-16 px-4",children:e.jsx("button",{onClick:k,className:`
            ...
            `,children:[e.jsx("div",{className:"absolute inset-0 rounded-[28px] bg-gradient-to-br from-[#C9A24A]/10 via-transparent to-[#B8943F]/10 pointer-events-none"}),e.jsx("div",{className:"absolute inset-[1px] rounded-[27px] border border-[#C9A24A]/10 pointer-events-none"}),e.jsx("div",{className:"relative z-10 flex items-center justify-center h-16 px-4",children:e.jsx("button",{onClick:_,className:`
                ...
                `,"aria-label":l?"Tutup sidebar":"Buka sidebar",children:e.jsx(H,{className:"w-5 h-5",strokeWidth:2.5})})}),e.jsx("div",{className:"mx-5 h-px bg-gradient-to-r from-transparent via-[#C9A24A]/40 to-transparent"}),e.jsx("nav",{className:"relative z-10 flex-1 flex flex-col gap-2 px-3 py-4",children:se.map(t=>{const c=B(t.href);if(s==="clinic"&&!!t.submenu?.length){const x=t.submenu.some(d=>B(d.href));return e.jsxs("button",{type:"button",onClick:d=>{const v=!A||k!==t.submenu;if(v){const T=d.currentTarget.getBoundingClientRect();D({top:T.top,left:T.right+12})}v&&!x&&M(t.href),g(t.submenu||[]),r(v)},className:`
                        group relative flex items-center
