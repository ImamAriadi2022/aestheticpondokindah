import{c as C,A as z,r as c,j as e,B as h,X as D,C as A,U,S as M}from"./index-FTFebfwa.js";import{D as P,a as E,b as T,f as B}from"./dialog-DMY2SvGm.js";import{F}from"./file-text-g4xxUil_.js";import{B as W}from"./building-2-C1T3bGYB.js";import{S,C as _}from"./shield-check-BIZYUKqt.js";import{S as J}from"./sparkles-BDY7o7WK.js";import{C as O}from"./shield-DvaNDB71.js";const H=[["path",{d:"M7.9 20A9 9 0 1 0 4 16.1L2 22Z",key:"vv11sd"}]],ae=C("message-circle",H);const G=[["path",{d:"M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2",key:"143wyd"}],["path",{d:"M6 9V3a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1v6",key:"1itne7"}],["rect",{x:"6",y:"14",width:"12",height:"8",rx:"1",key:"1ue0tg"}]],N=C("printer",G);async function K(){const n=await fetch(`${z}/public/settings`,{headers:{Accept:"application/json"}});return n.ok?n.json():{}}function te({isOpen:n,onClose:l,onAccept:m,showAcceptButton:r=!1}){const[j,p]=c.useState(null),[i,g]=c.useState(null),[b,x]=c.useState(!1);c.useEffect(()=>{n&&(x(!0),K().then(t=>{t.pdf_terms_and_conditions&&g(t.pdf_terms_and_conditions),t.booking_terms&&t.booking_terms.trim().length>0&&p(t.booking_terms)}).catch(()=>{}).finally(()=>x(!1)))},[n]);const d=()=>{const t=document.createElement("iframe");t.style.position="fixed",t.style.right="0",t.style.bottom="0",t.style.width="0",t.style.height="0",t.style.border="0",document.body.appendChild(t);const o=t.contentWindow?.document;if(!o){window.print();return}const v=i?.kop?.logoWidth||75,a=i?.kop?.logoHeight||75,y=i?.sections&&i.sections.length>0?i.sections.map(u=>`
