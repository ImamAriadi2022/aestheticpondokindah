import{c as w,A as z,r as c,j as e,B as h,X as D,C as A,U as M,S as U}from"./index-AIocL1Ww.js";import{D as P,a as E,b as T,f as F}from"./dialog-BLRi8m7F.js";import{F as B}from"./file-text-DIul2Iym.js";import{B as _}from"./map-pin-DVlduGKN.js";import{S}from"./shield-check-D1wEHYFV.js";import{S as W}from"./sparkles-CbjKMqy1.js";import{C as J}from"./message-square-DLyO2Xrp.js";import{C as H}from"./clock-Db4aKKhV.js";const O=[["path",{d:"M7.9 20A9 9 0 1 0 4 16.1L2 22Z",key:"vv11sd"}]],se=w("message-circle",O);const G=[["path",{d:"M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2",key:"143wyd"}],["path",{d:"M6 9V3a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1v6",key:"1itne7"}],["rect",{x:"6",y:"14",width:"12",height:"8",rx:"1",key:"1ue0tg"}]],N=w("printer",G);const V=[["path",{d:"M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8",key:"1357e3"}],["path",{d:"M3 3v5h5",key:"1xhq8a"}]],ne=w("rotate-ccw",V);async function K(){const i=await fetch(`${z}/public/settings`,{headers:{Accept:"application/json"}});return i.ok?i.json():{}}function ie({isOpen:i,onClose:l,onAccept:m,showAcceptButton:r=!1}){const[j,p]=c.useState(null),[t,g]=c.useState(null),[b,x]=c.useState(!1);c.useEffect(()=>{i&&(x(!0),K().then(s=>{s.pdf_terms_and_conditions&&g(s.pdf_terms_and_conditions),s.booking_terms&&s.booking_terms.trim().length>0&&p(s.booking_terms)}).catch(()=>{}).finally(()=>x(!1)))},[i]);const d=()=>{const s=document.createElement("iframe");s.style.position="fixed",s.style.right="0",s.style.bottom="0",s.style.width="0",s.style.height="0",s.style.border="0",document.body.appendChild(s);const o=s.contentWindow?.document;if(!o){window.print();return}const y=t?.kop?.logoWidth||75,a=t?.kop?.logoHeight||75,v=t?.bodyHtml||(t?.sections&&t.sections.length>0?t.sections.map(u=>`
      ...
      <html>
        <head>
          <meta charset="utf-8" />
          <title>${t?.docTitle||"Syarat dan Ketentuan Layanan Pasien"} - Aesthetic Pondok Indah</title>
          <style>
            @page {
              size: A4 portrait;
              margin: 16mm 14mm;
            ...
            * {
            ...
            body {
              ...
              margin: 0;
              padding: 0;
              font-size: ${t?.baseFontSize||"9.5pt"};
              background: #fff;
            }
            .kop-header {
              display: flex;
            ...
            .kop-logo img { width: ${y}px; height: ${a}px; object-fit: contain; }
          ...
          <style>
            ...
            * {
            ...
            body {
              ...
              margin: 0;
              padding: 0;
              font-size: ${a?.baseFontSize||"9.5pt"};
              background: #fff;
            }
            .kop-header {
              display: flex;
        ...
        <body>
          ...
          <div class="meta-box">
            <div>
              ...
              <div class="meta-item"><span class="meta-label">Layanan Tindakan:</span> <span class="meta-value">${t}</span></div>
            </div>
            <div>
