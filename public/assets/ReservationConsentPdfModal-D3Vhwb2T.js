import{c as oa,r as i,j as a,X as Z}from"./index-2V8ebxjb.js";import{r as aa}from"./index-Bup8Z0wn.js";import{B as P}from"./button-BkF51KJ5.js";import{g as ea}from"./clinicSettingsApi-BpCHQ9Ct.js";import{F as ta}from"./file-text-BxraTA33.js";import{P as na}from"./printer-MCEdXYul.js";import{C as G}from"./check-BB28Ul0e.js";const ca=[["path",{d:"M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8",key:"1357e3"}],["path",{d:"M3 3v5h5",key:"1xhq8a"}]],ba=oa("rotate-ccw",ca);function ya({isOpen:p,onClose:u,onAccept:S,initialName:d="",initialEmail:h="",initialPhone:A="",initialSignature:sa,isAgreed:f=!1,showAcceptButton:I=!0,readOnly:H}){const W=H||!S||!I,[r,j]=i.useState(null),[U,T]=i.useState(null),[g,D]=i.useState(d),[J,z]=i.useState(f),[_,v]=i.useState(null);i.useEffect(()=>{d&&D(d),z(f)},[d,f]),i.useEffect(()=>{p&&(v(null),ea().then(s=>{s.pdf_terms_and_conditions&&T(s.pdf_terms_and_conditions),s.booking_terms&&s.booking_terms.trim().length>0&&j(s.booking_terms)}).catch(()=>{}))},[p]);const w=()=>{if(!J){v("Harap centang kotak persetujuan Syarat dan Ketentuan.");return}if(!g.trim()){v("Harap lengkapi nama Anda.");return}S&&S(g.trim()),u()},R=()=>{const s=document.createElement("iframe");s.style.position="fixed",s.style.right="0",s.style.bottom="0",s.style.width="0",s.style.height="0",s.style.border="0",document.body.appendChild(s);const k=s.contentWindow?.document;if(!k){window.print();return}const X=`
      <!DOCTYPE html>
      <html>
        <head>
          <meta charset="utf-8" />
