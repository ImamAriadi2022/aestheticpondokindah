...
import { Eye, EyeOff, ArrowLeft, ChevronRight, Heart, Lock, Phone, MessageCircle, User } from "lucide-react";
...
export default function MobileLoginPage() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    if (!cleanName || cleanName.length < 2) {
      setRegisterError("Nama pengguna / lengkap wajib diisi minimal 2 karakter.");
      return;
    }
    ...
    try {
      ...
      toast({ title: "Pendaftaran Berhasil", message: "Selamat datang di Aesthetic Pondok Indah!", variant: "success" });
      ...
      <div className="min-h-screen bg-white flex flex-col">
        ...
        <div className="flex-1 px-6 overflow-y-auto">
          <form onSubmit={handleRegister} className="space-y-4 pb-8">
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-gray-700">Nama Pengguna / Lengkap</label>
              <div className="relative">
                ...
                <Input
                  ...
                  className="w-full h-14 pl-12 pr-4 bg-gray-50 border-0 rounded-xl text-base focus:ring-2 focus:ring-[#c9a24a]/30 font-semibold text-gray-900"
                  required
                />
              </div>
            </div>
