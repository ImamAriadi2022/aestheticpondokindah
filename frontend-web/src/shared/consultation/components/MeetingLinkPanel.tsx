...
import { MEETING_PROVIDERS } from "@/shared/consultation/constants/consultation";
import type {
  ConsultationMeeting,
  MeetingInput,
  MeetingProvider,
} from "@/shared/consultation/types/consultation";
import { formatMeetingDate, toDateTimeLocal } from "@/shared/consultation/utils/format";
...
export function MeetingLinkPanel({
  ...
  const canManage = !disabled && !readOnly;
            ...
            >
              <div className="flex items-center justify-between gap-2">
                ...
                {canManage ? (
                  ...
                  <Button variant="ghost" size="icon-xs" asChild className="text-sky-600 hover:bg-sky-50 shrink-0">
                    <a href={meeting.url} target="_blank" rel="noreferrer">
                      <ExternalLink className="w-3.5 h-3.5" />
                    </a>
                  </Button>
