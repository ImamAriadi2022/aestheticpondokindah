...
import { formatChatDate, formatChatTime } from "@/features/doctor/consultation/utils/format";
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0">
            ...
            <p className="text-xs text-[#8A7B6B] truncate">
              Pesan terkirim secara langsung ke pasien
            </p>
          </div>
        </div>
      </div>
        ...
        {disabled ? (
          ...
          <div className="flex items-end gap-2">
            <Textarea
              ...
              placeholder="Tulis pesan ke pasien..."
              rows={1}
