  ...
  return (
    <DashboardLayout role={sessionRole}>
      <div className="w-full max-w-5xl mx-auto px-4 py-6 space-y-6">
        ...
        <div className="bg-white rounded-3xl border border-gray-100 shadow-sm p-4 sm:p-5 transition-all">
          {googleLinked ? (
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
              <div className="flex items-center gap-3.5">
                <div className="w-11 h-11 rounded-2xl bg-gray-50 border border-gray-200/80 flex items-center justify-center shrink-0 shadow-2xs">
                ...
                <div>
                  <div className="flex items-center gap-2">
                    <h4 className="text-sm font-bold text-gray-900">Terhubung dengan Akun Google</h4>
                  ...
                  <p className="text-xs text-gray-500 mt-0.5">
                    {googleEmail || profile.email || "Akun Google terhubung untuk login cepat 1-klik."}
                  </p>
                </div>
              </div>
              <div className="sm:self-center">
                <span className="text-xs text-emerald-700 bg-emerald-50 px-3 py-1.5 rounded-xl border border-emerald-200 font-semibold inline-block">
                  ✓ Login 1-Klik Aktif
                </span>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div className="flex items-center gap-3.5">
                ...
                <div>
                  <h4 className="text-sm font-bold text-gray-900">Hubungkan ke Akun Google</h4>
                  <p className="text-xs text-gray-500 mt-0.5">
                    Hubungkan akun Google Anda untuk kemudahan login cepat 1-klik tanpa repot memasukkan kata sandi.
                  </p>
                </div>
              </div>
              <div className="shrink-0">
                <GoogleAuthButton
                  ...
                  className="!h-10 !text-xs !px-4 shadow-sm"
                />
              </div>
            </div>
          )}
