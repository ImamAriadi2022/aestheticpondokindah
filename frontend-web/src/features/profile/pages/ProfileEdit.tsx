...
import { JOB_OPTIONS, GENDER_OPTIONS, BLOOD_TYPE_OPTIONS } from "@/shared/lib/regionData";
import { getProvinces, getRegencies, getDistricts, type WilayahItem } from "@/shared/lib/wilayahApi";
              ...
              <CardContent className="p-6 space-y-5">
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(val) => setProfile((prev) => ({ ...prev, specialization: val }))}
                  >
